...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibrary.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@mavogel/mvc-projen.MvcCdkConstructLibrary.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@mavogel/mvc-projen.MvcCdkConstructLibrary.with.parameter.mixins"></a>
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibrary.property.biome">biome</a></code> | <code>projen.javascript.Biome</code> | *No description.* |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibrary.property.runner">runner</a></code> | <code>projen.typescript.TypeScriptRunner</code> | The TypeScript runner used for executing TypeScript files. |
...
##### `biome`<sup>Optional</sup> <a name="biome" id="@mavogel/mvc-projen.MvcCdkConstructLibrary.property.biome"></a>
...
##### `runner`<sup>Required</sup> <a name="runner" id="@mavogel/mvc-projen.MvcCdkConstructLibrary.property.runner"></a>
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.projectTree">projectTree</a></code> | <code>boolean</code> | Generate a project tree file (`.projen/tree.json`) that shows all components and their relationships. Useful for understanding your project structure and debugging. |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.config">config</a></code> | <code>{[ key: string ]: any}</code> | Configuration values available to package scripts at runtime. |
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.dedupeDeps">dedupeDeps</a></code> | <code>boolean</code> | Add a `dedupe` task that deduplicates project dependencies. |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.npmTrustedPublishing">npmTrustedPublishing</a></code> | <code>boolean</code> | Use trusted publishing for publishing to npmjs.com Needs to be pre-configured on npm.js to work. |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.auditDeps">auditDeps</a></code> | <code>boolean</code> | Run security audit on dependencies. |
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.auditDepsOptions">auditDepsOptions</a></code> | <code>projen.javascript.AuditOptions</code> | Security audit options. |
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.biome">biome</a></code> | <code>boolean</code> | Setup Biome. |
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.biomeOptions">biomeOptions</a></code> | <code>projen.javascript.BiomeOptions</code> | Biome options. |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.disableTsconfigDev">disableTsconfigDev</a></code> | <code>boolean</code> | Do not generate a development tsconfig file. |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.runner">runner</a></code> | <code>projen.typescript.TypeScriptRunner</code> | The TypeScript runner to use for executing TypeScript files. |
...
| <code><a href="#@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.validateTsconfig">validateTsconfig</a></code> | <code>projen.cdk.ValidateTsconfig</code> | Level of tsconfig validation jsii should perform on the user-provided tsconfig. |
...
##### `projectTree`<sup>Optional</sup> <a name="projectTree" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.projectTree"></a>
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.allowScripts"></a>
...
##### `config`<sup>Optional</sup> <a name="config" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.config"></a>
...
##### `dedupeDeps`<sup>Optional</sup> <a name="dedupeDeps" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.dedupeDeps"></a>
...
##### `npmTrustedPublishing`<sup>Optional</sup> <a name="npmTrustedPublishing" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.npmTrustedPublishing"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.pnpmOptions"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.releaseWorkflowEnv"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.auditDepsOptions"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.biome"></a>
...
##### `biomeOptions`<sup>Optional</sup> <a name="biomeOptions" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.biomeOptions"></a>
...
##### `defaultReleaseBranch`<sup>Optional</sup> <a name="defaultReleaseBranch" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.defaultReleaseBranch"></a>
...
##### `runner`<sup>Optional</sup> <a name="runner" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.runner"></a>
...
##### `validateTsconfig`<sup>Optional</sup> <a name="validateTsconfig" id="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions.property.validateTsconfig"></a>
