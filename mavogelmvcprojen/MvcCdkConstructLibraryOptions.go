...
type MvcCdkConstructLibraryOptions struct {
	...
	//
	// Experimental.
	LambdaOptions *awscdk.LambdaFunctionCommonOptions `field:"optional" json:"lambdaOptions" yaml:"lambdaOptions"`
	...
	//
	IntegTestRegions *[]*string `field:"optional" json:"integTestRegions" yaml:"integTestRegions"`
}
